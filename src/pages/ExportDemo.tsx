...
import { AlertContainer, Button } from "../components/ui";
...
const SAMPLE_DATA: Record<string, unknown>[] = [
  ...
  },
  {
    ...
    maxSeats: 50,
    maxCatalogItems: 500,
    features: ["Priority support", "API access", "Webhooks"],
    sortOrder: 2,
    status: "active",
  },
  {
    ...
    maxSeats: -1,
    maxCatalogItems: -1,
    features: ["Dedicated support", "SLA", "SSO", "Custom integrations"],
    sortOrder: 3,
    status: "active",
  },
];
  ...
  const handleExport = useCallback(
    async (config: ExportConfig) => {
      ...
      if (result.status === "success") {
        showAlert(
          "success",
          `Exported ${result.metadata.recordCount} records → ${result.filename}`,
        );
        setExportOpen(false);
      ...
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <section className="bg-[#121212] border border-[#333] rounded-xl p-6">
          ...
          <p className="text-sm text-gray-400 mb-4">
            Opens the export modal with sample plan data. Test PDF and XLSX generation, field
            selection, redaction, preview, and cancellation.
          </p>
        ...
        <section className="bg-[#121212] border border-[#333] rounded-xl p-6">
          ...
          <p className="text-sm text-gray-400 mb-4">
            Trigger alerts to test auto-dismiss, pause-on-hover, keyboard dismiss (Esc), and
            stacking.
          </p>
        ...
        <section className="bg-[#121212] border border-[#333] rounded-xl p-6">
          ...
          <ul className="space-y-2 text-sm text-gray-400">
            ...
            <li>
              • Press <kbd className="px-1.5 py-0.5 bg-[#222] rounded text-gray-300">Esc</kbd> while
              an alert is focused → should dismiss
            </li>
