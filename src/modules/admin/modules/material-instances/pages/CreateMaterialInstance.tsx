  ...
  const handleSubmit = async (data: CreateMaterialInstancePayload) => {
    try {
      if (isEditing) {
        ...
        showToast('warning', 'Editing instances is not fully supported. Please delete and create a new one.');
        return;
      } else {
        await addInstance(data);
        showToast('success', 'Material instance created successfully!');
      }
      navigate('/admin/material-instances');
    } catch (error: any) {
  ...
  return (
    <div className="min-h-screen bg-[#121212] p-8">
      <div className="max-w-3xl mx-auto">
        {/* Header */}
        <button
          onClick={() => navigate('/admin/material-instances')}
        ...
        <div className="bg-[#1a1a1a] border border-[#333] rounded-lg p-6">
          <MaterialInstanceForm
            ...
            onCancel={() => navigate('/admin/material-instances')}
