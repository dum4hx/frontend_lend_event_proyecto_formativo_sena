  ...
  sections: [
    {
      ...
      howTo: [
        { es: "Abre el modulo desde Configuracion > Precios.", en: "Open the module from Settings > Pricing." },
        { es: "Usa los filtros de alcance y estrategia para revisar configuraciones existentes.", en: "Use the scope and strategy filters to review existing configurations." },
        { es: "Haz clic en 'Nueva configuracion' para definir una estrategia de precio para un material o paquete.", en: "Click 'New configuration' to define a pricing strategy for a material or package." },
      ],
      tips: [
        {
    ...
    },
    {
      ...
      howTo: [
        { es: "Para crear: haz clic en 'Nueva configuracion', selecciona alcance, estrategia y define los parametros.", en: "To create: click 'New configuration', select scope, strategy, and define parameters." },
        { es: "Para simular: abre la herramienta de vista previa, ingresa valores de prueba y valida el calculo.", en: "To simulate: open the preview tool, enter test values, and validate the calculation." },
        { es: "Para editar: localiza la configuracion en la tabla y usa la accion de edicion.", en: "To edit: locate the configuration in the table and use the edit action." },
      ],
      bestPractices: [
        {
    ...
    },
    {
      ...
      howTo: [
        { es: "Filtra por alcance (global, tipo de material, paquete) para revisar reglas existentes.", en: "Filter by scope (global, material type, package) to review existing rules." },
        { es: "Usa Price Preview para simular el calculo antes de guardar cambios.", en: "Use Price Preview to simulate the calculation before saving changes." },
        { es: "Ajusta los parametros segun el resultado esperado y guarda la configuracion.", en: "Adjust parameters based on the expected result and save the configuration." },
      ],
      warnings: [
        {
    ...
    },
    {
      ...
      howTo: [
        { es: "Revisa el campo 'Alcance' y el item objetivo antes de guardar cualquier estrategia.", en: "Review the 'Scope' field and target item before saving any strategy." },
        { es: "Simula el precio con la herramienta de vista previa para confirmar el resultado esperado.", en: "Simulate the price with the preview tool to confirm the expected result." },
        { es: "Si el precio calculado es incorrecto, verifica que la estrategia no este duplicada con diferente alcance.", en: "If the calculated price is incorrect, verify the strategy is not duplicated with different scope." },
      ],
    },
  ],
  walkthrough: [
