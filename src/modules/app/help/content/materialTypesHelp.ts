  ...
  sections: [
    {
      ...
      howTo: [
        {
          es: "Abre el modulo desde el menu lateral en Materiales > Tipos.",
          en: "Open the module from the sidebar under Materials > Types.",
        },
        {
          es: "Usa la barra de busqueda para encontrar un tipo por nombre.",
          en: "Use the search bar to find a type by name.",
        },
        {
          es: "Aplica filtros de categoria para acotar los resultados.",
          en: "Apply category filters to narrow the results.",
        },
        {
          es: "Haz clic en un registro para ver detalles, editar o eliminar.",
          en: "Click a record to view details, edit, or delete.",
        },
      ],
      tips: [
        {
    ...
    },
    {
      ...
      howTo: [
        {
          es: "Para crear: haz clic en 'Nuevo tipo', completa nombre, categoria y precio, y guarda.",
          en: "To create: click 'New type', fill in name, category, and price, then save.",
        },
        {
          es: "Para importar: descarga la plantilla, llena los campos y sube el archivo CSV/Excel.",
          en: "To import: download the template, fill in the fields, and upload the CSV/Excel file.",
        },
        {
          es: "Para editar: localiza el tipo, abre el menu de acciones y selecciona Editar.",
          en: "To edit: locate the type, open the action menu, and select Edit.",
        },
        {
          es: "Para eliminar: confirma que el tipo no tenga instancias activas antes de proceder.",
          en: "To delete: confirm the type has no active instances before proceeding.",
        },
      ],
      bestPractices: [
        {
    ...
    },
    {
      ...
      howTo: [
        {
          es: "Escribe el nombre del tipo en la barra de busqueda.",
          en: "Type the type name in the search bar.",
        },
        {
          es: "Selecciona una categoria en el filtro para reducir resultados.",
          en: "Select a category in the filter to narrow results.",
        },
        {
          es: "Revisa las tarjetas de metricas para ver totales y resultados filtrados.",
          en: "Check the metrics cards to see totals and filtered results.",
        },
        {
          es: "Haz clic en '+ Nuevo tipo' para crear un nuevo registro con los datos requeridos.",
          en: "Click '+ New type' to create a new record with the required data.",
        },
      ],
      warnings: [
        {
    ...
    },
    {
      ...
      howTo: [
        {
          es: "Ve a Categorias, verifica que las categorias necesarias existan y copia sus IDs.",
          en: "Go to Categories, verify the required categories exist, and copy their IDs.",
        },
        {
          es: "Descarga la plantilla de importacion y nsertalos en la columna categoryId.",
          en: "Download the import template and insert them in the categoryId column.",
        },
        {
          es: "Sube el archivo y revisa el mensaje de resultado para confirmar que no hubo errores.",
          en: "Upload the file and review the result message to confirm there were no errors.",
        },
      ],
    },
  ],
