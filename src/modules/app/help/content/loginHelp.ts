  ...
  sections: [
    {
      ...
      howTo: [
        {
          en: "Type your email address in the Email field.",
          es: "Escribe tu correo electronico en el campo Email.",
        },
        {
        ...
        },
        {
          ...
          es: "Haz clic en 'Iniciar sesion' — si las credenciales son validas, seras redirigido a la pantalla de verificacion OTP.",
        },
      ],
      tips: [
        {
    ...
    },
    {
      ...
      howTo: [
        {
          en: "Open your email inbox and locate the message from LendEvent.",
          es: "Abre tu bandeja de entrada y localiza el mensaje de LendEvent.",
        },
        {
          en: "Type each digit into the corresponding input box, or paste all 6 digits at once.",
          es: "Escribe cada digito en el campo correspondiente, o pega los 6 digitos de una vez.",
        },
        {
          en: "Click 'Verify' to submit the code.",
          es: "Haz clic en 'Verificar' para enviar el codigo.",
        },
      ],
      tips: [
        {
          en: "The code auto-advances the cursor between digit boxes as you type.",
          es: "El cursor avanza automaticamente entre los campos mientras escribes.",
        },
        {
          en: "If the code expires, click 'Resend code' to request a fresh one.",
          es: "Si el codigo caduca, haz clic en 'Reenviar codigo' para solicitar uno nuevo.",
        },
      ],
      warnings: [
        {
          en: "After 5 failed attempts the session is locked. Use 'Resend code' or go back and sign in again.",
          es: "Tras 5 intentos fallidos la sesion se bloquea. Usa 'Reenviar codigo' o vuelve e inicia sesion de nuevo.",
        },
      ],
    },
    {
      ...
      howTo: [
        {
          en: "Click 'Use a backup code' below the OTP form.",
          es: "Haz clic en 'Usar un codigo de respaldo' debajo del formulario OTP.",
        },
        {
          en: "Enter one of your saved backup codes exactly as it appears.",
          es: "Ingresa uno de tus codigos de respaldo guardados exactamente como aparece.",
        },
        {
          en: "Click 'Verify backup code' to complete sign-in.",
          es: "Haz clic en 'Verificar codigo de respaldo' para completar el inicio de sesion.",
        },
      ],
      warnings: [
        {
          en: "Each backup code can only be used once. Keep them stored safely.",
          es: "Cada codigo de respaldo solo puede usarse una vez. Guardalos en un lugar seguro.",
        },
      ],
    },
    {
      ...
      title: {
        en: "Saving backup codes (first login only)",
        es: "Guardar codigos de respaldo (solo primer inicio de sesion)",
      },
      body: {
      ...
      howTo: [
        {
          en: "Click 'Copy all codes' to copy them to your clipboard.",
          es: "Haz clic en 'Copiar todos los codigos' para copiarlos al portapapeles.",
        },
        {
          en: "Or click 'Download .txt' to save them as a text file.",
          es: "O haz clic en 'Descargar .txt' para guardarlos como archivo de texto.",
        },
        {
          en: "Check the acknowledgement checkbox and click 'I have saved my codes' to continue.",
          es: "Marca la casilla de confirmacion y haz clic en 'He guardado mis codigos' para continuar.",
        },
      ],
      warnings: [
        {
  ...
  walkthrough: [
    {
      ...
      body: {
        en: "Type the email address registered to your LendEvent account.",
        es: "Escribe el correo electronico registrado en tu cuenta de LendEvent.",
      },
    ...
    },
    {
      ...
      body: {
        en: "Click Sign In. On success you will be taken to the OTP verification screen.",
        es: "Haz clic en Iniciar sesion. Si es exitoso, seras llevado a la pantalla de verificacion OTP.",
      },
    ...
    },
    {
      ...
      body: {
        en: "Type or paste the one-time code sent to your email into the 6 digit boxes.",
        es: "Escribe o pega el codigo de un solo uso enviado a tu correo en los 6 campos.",
      },
    ...
    },
    {
      ...
      body: {
        en: "Click Verify to authenticate. If correct you will be redirected to your dashboard.",
        es: "Haz clic en Verificar para autenticarte. Si es correcto seras redirigido a tu panel.",
      },
    ...
    },
    {
      ...
      body: {
        en: "If the code expired or was not delivered, click Resend code to get a new one.",
        es: "Si el codigo caduco o no llego, haz clic en Reenviar codigo para obtener uno nuevo.",
      },
    ...
    },
    {
      ...
      body: {
        en: "If you cannot receive the OTP by email, click this link to switch to backup code entry.",
        es: "Si no puedes recibir el OTP por correo, haz clic en este enlace para cambiar al ingreso de codigo de respaldo.",
      },
      ...
      fields: [
        {
          ...
          purpose: {
            en: "The email address associated with your LendEvent account.",
            es: "El correo electronico asociado a tu cuenta de LendEvent.",
          },
          required: true,
      ...
      actions: [
        {
          ...
          purpose: {
            en: "Validates credentials and redirects to OTP verification.",
            es: "Valida las credenciales y redirige a la verificacion OTP.",
          },
          consequence: {
            en: "You will be taken to the OTP verification step.",
            es: "Seras redirigido al paso de verificacion OTP.",
          },
          selector: "[data-help-id='login-submit-button']",
        },
      ],
      ...
      fields: [
        {
          ...
          purpose: {
            en: "The one-time code emailed to you after credential verification.",
            es: "El codigo de un solo uso enviado por correo tras la verificacion de credenciales.",
          },
          required: true,
      ...
      actions: [
        {
          ...
          purpose: {
            en: "Submits the OTP and completes authentication.",
            es: "Envia el OTP y completa la autenticacion.",
          },
          consequence: {
            en: "You will be signed in and redirected to your dashboard.",
            es: "Iniciaras sesion y seras redirigido a tu panel.",
          },
        ...
        },
        {
          ...
          purpose: {
            en: "Requests a new OTP and resets the 5-minute timer.",
            es: "Solicita un nuevo OTP y restablece el temporizador de 5 minutos.",
          },
          consequence: {
            en: "A new code is sent to your email and the timer resets.",
            es: "Se envia un nuevo codigo a tu correo y el temporizador se reinicia.",
          },
