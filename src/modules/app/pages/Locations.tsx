...
export default function LocationsPage() {
  ...
  const handleCreate = async () => {
    ...
    if (!Number.isFinite(form.occupied) || form.occupied < 0)
      errs.occupied = "Occupied must be >= 0";
    ...
    if (!form.address?.street || !form.address.street.trim())
      errs["address.street"] = "Street is required";
    if (!form.address?.propertyNumber || !form.address.propertyNumber.trim())
      errs["address.propertyNumber"] = "Property number is required";
  ...
  const openEdit = (loc: WarehouseLocation) => {
    ...
    setForm({
      ...
      occupied: loc.occupied ?? 0,
      status: loc.status ?? "available",
      address: {
        country: loc.address?.country ?? "",
        city: loc.address?.city ?? "",
        street: loc.address?.street ?? "",
        propertyNumber: loc.address?.propertyNumber ?? "",
      },
    });
        ...
        >
          <div className="bg-[#0f0f10] border border-[#2a2a2a] rounded-xl max-w-lg w-full p-6 shadow-lg">
            ...
            <p className="text-gray-400 text-sm mb-5">
              Add a new warehouse location. Fields marked with * are required.
            </p>
            <form
              onSubmit={(e) => {
                e.preventDefault();
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div>
                  ...
                  />
                  {fieldErrors.name && (
                    <p className="text-xs text-yellow-400 mt-1">{fieldErrors.name}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      setFieldErrors((s) => ({ ...s, code: undefined }));
                    }}
                    placeholder="e.g. A-12"
                    className="w-full h-12 px-4 bg-[#111111] border border-[#262626] rounded-md text-white placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-[#FFD700]"
                  />
                  {fieldErrors.code && (
                    <p className="text-xs text-yellow-400 mt-1">{fieldErrors.code}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      setFieldErrors((s) => ({ ...s, section: undefined }));
                    }}
                    placeholder="e.g. Zone 1"
                    className="w-full h-12 px-4 bg-[#111111] border border-[#262626] rounded-md text-white placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-[#FFD700]"
                  />
                  {fieldErrors.section && (
                    <p className="text-xs text-yellow-400 mt-1">{fieldErrors.section}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  <input
                    value={form.shelf}
                    onChange={(e) => {
                      updateForm("shelf", e.target.value);
                      setFieldErrors((s) => ({ ...s, shelf: undefined }));
                    }}
                    placeholder="e.g. Shelf A"
                    className="w-full h-12 px-4 bg-[#111111] border border-[#262626] rounded-md text-white placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-[#FFD700]"
                  />
                  {fieldErrors.shelf && (
                    <p className="text-xs text-yellow-400 mt-1">{fieldErrors.shelf}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      setFieldErrors((s) => ({ ...s, capacity: undefined }));
                    }}
                    placeholder="0"
                  ...
                  {fieldErrors.capacity && (
                    <p className="text-xs text-yellow-400 mt-1">{fieldErrors.capacity}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      setFieldErrors((s) => ({ ...s, occupied: undefined }));
                    }}
                    placeholder="0"
                    className="w-full h-12 px-4 bg-[#111111] border border-[#262626] rounded-md text-white placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-[#FFD700]"
                  />
                  {fieldErrors.occupied && (
                    <p className="text-xs text-yellow-400 mt-1">{fieldErrors.occupied}</p>
                  )}
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row gap-3">
                <div className="flex-1">
                  ...
                  <input
                    ...
                    placeholder="Country"
                    className="w-full px-3 py-2 bg-[#1a1a1a] border border-[#333] rounded-md text-white"
                  />
                  {fieldErrors["address.country"] && (
                    <p className="text-xs text-yellow-400 mt-1">{fieldErrors["address.country"]}</p>
                  )}
                </div>
                <div className="flex-1">
                  ...
                  {fieldErrors["address.city"] && (
                    <p className="text-xs text-yellow-400 mt-1">{fieldErrors["address.city"]}</p>
                  )}
                </div>
                <div className="flex-1">
                  ...
                  {fieldErrors["address.street"] && (
                    <p className="text-xs text-yellow-400 mt-1">{fieldErrors["address.street"]}</p>
                  )}
                </div>
                <div className="flex-1">
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      updateAddressField("propertyNumber", e.target.value);
              ...
              <div className="flex items-center gap-4 pt-4">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-[#141414] text-gray-300 font-medium rounded-md hover:bg-[#1b1b1b] transition-colors border border-[#333]"
                >
                  Cancel
                </button>
              </div>
            ...
            >
              ...
              <div className="flex gap-4 pt-4">
                ...
                <button
                  ...
                  className="px-6 py-3 bg-[#1a1a1a] text-gray-300 font-semibold rounded-lg hover:bg-[#222] transition-colors border border-[#333]"
                >
                  Cancel
                </button>
              </div>
