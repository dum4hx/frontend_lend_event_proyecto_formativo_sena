  ...
  return (
    <AnimatedPage>
      <div className="page-container">
        ...
        {/* Tabs */}
        <div data-help-id="transfer-requests-tabs" className="flex gap-1 bg-[#111] border border-[#222] rounded-lg p-1 w-fit">
        ...
        {activeTab === "requests" && (
          <div className="space-y-4">
            {/* Filters row */}
            <div data-help-id="transfer-requests-request-filters" className="flex items-center gap-3 flex-wrap">
            ...
            {/* Table */}
            <div data-help-id="transfer-requests-request-table" className="bg-[#111] border border-[#222] rounded-xl overflow-hidden">
              {requestsLoading ? (
        ...
        {activeTab === "shipments" && (
          <div className="space-y-4">
            {/* Filters row */}
            <div data-help-id="transfer-requests-shipment-filters" className="flex items-center gap-3 flex-wrap">
              <div className="relative">
                <select
            ...
            {/* Table */}
            <div data-help-id="transfer-requests-shipment-table" className="bg-[#111] border border-[#222] rounded-xl overflow-hidden">
              {transfersLoading ? (
                <div className="flex items-center justify-center py-16 text-gray-500">
                  <RefreshCw size={20} className="animate-spin mr-2" />
