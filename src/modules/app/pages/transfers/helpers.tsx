import type { TransferRequestStatus, TransferStatus, TransferCondition, MaterialInstance } from "./types";
...
export const StatusBadgeInline: React.FC<StatusBadgeProps> = ({ label, className }) => (
  <span
...
export const TransferRoute: React.FC<TransferRouteProps> = ({ fromLocation, toLocation }) => {
  return (
