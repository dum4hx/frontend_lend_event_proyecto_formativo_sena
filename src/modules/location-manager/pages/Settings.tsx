  ...
  return (
    <div className="space-y-8 max-w-4xl">
      ...
      <div>
        ...
        <p className="text-gray-400 mt-1">Manage your location preferences and notifications</p>
      </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between p-4 bg-[#121212] rounded-[8px] border border-[#333]">
              <div>
                ...
                <p className="text-gray-400 text-sm">Get notified when items run low</p>
              </div>
            ...
            <div className="flex items-center justify-between p-4 bg-[#121212] rounded-[8px] border border-[#333]">
              <div>
                ...
                <p className="text-gray-400 text-sm">Get notified for new rental orders</p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  type="checkbox"
            ...
            <div className="flex items-center justify-between p-4 bg-[#121212] rounded-[8px] border border-[#333]">
              <div>
                <p className="font-semibold text-white">Automatic Backup</p>
