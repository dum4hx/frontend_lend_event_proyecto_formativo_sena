...
export default function Header() {
  ...
  useEffect(() => {
    // eslint-disable-next-line react-hooks/set-state-in-effect -- close menu on route change is a well-known pattern
      ...
      <nav className="mx-auto flex w-full max-w-7xl items-center justify-between gap-4 px-5 py-4 md:px-8 md:py-4">
        <div>
          <Link to="/" className="flex items-center gap-2.5 hover:opacity-90 transition">
            <img src="/lendevent-logo.png" alt="LendEvent" className="h-10 w-auto" />
        ...
        <div className="flex items-center gap-2.5 md:gap-3">
          ...
          <button
            ...
            aria-label={
              isMobileMenuOpen ? t("publicSite.nav.closeMenu") : t("publicSite.nav.openMenu")
            }
