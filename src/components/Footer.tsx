      ...
      <div className="mx-auto max-w-7xl px-6 py-12 text-sm md:py-14">
        <section className="mb-10 grid grid-cols-1 gap-6 rounded-2xl border border-zinc-900 bg-zinc-950/55 p-6 md:grid-cols-[1.7fr_1fr] md:items-center md:p-7">
          <div className="space-y-3">
            ...
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-zinc-500">LendEvent Platform</p>
            <h2 className="text-2xl font-extrabold tracking-tight text-white md:text-3xl">
              Run event operations with control and confidence
            </h2>
            <p className="max-w-2xl text-sm leading-relaxed text-zinc-400">
              Streamline inventory, billing, and team workflows in one place. Built for event businesses that need speed,
              traceability, and reliable execution.
            </p>
          </div>
        ...
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4 md:gap-10">
          <div>
            <h6 className="mb-4 font-bold text-white">Support</h6>
            <ul className="space-y-2.5 text-zinc-400">
              <li><Link to="/contact" className="transition-colors hover:text-white">Contact</Link></li>
              <li><Link to="/billing" className="transition-colors hover:text-white">Billing</Link></li>
            </ul>
          </div>

          <div>
            <h6 className="mb-4 font-bold text-white">Company</h6>
            <ul className="space-y-2.5 text-zinc-400">
          ...
          <div>
            <h6 className="mb-4 font-bold text-white">Resources</h6>
            <ul className="space-y-2.5 text-zinc-400">
              <li><Link to="/whats-new" className="transition-colors hover:text-white">What's New</Link></li>
              <li><Link to="/help-center" className="transition-colors hover:text-white">Help Center</Link></li>
            </ul>
          </div>

          <div>
            <h6 className="mb-4 font-bold text-white">Location</h6>
        ...
        <div className="mt-10 flex flex-wrap items-center gap-x-6 gap-y-3 border-t border-zinc-800 pt-6 text-xs text-zinc-500">
          <span>© 2026 Lend-Event. All rights reserved.</span>
          ...
          <span className="hidden md:inline">Built for high-performance event teams.</span>
        </div>
      </div>
    </footer>
  )
